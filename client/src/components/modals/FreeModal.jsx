  ...
  const onClick = async () => {
    ...
    try {
      ...
      if (affiliator.freeMoneyClaimed) {
        addToast("You have successfully claimed your free 💵 0.50 cash. Enjoy! :)", {
          appearance: "success",
        });
      ...
      <DialogContent dividers>
        {loading ? (
          ...
          <Fragment>
            ...
            <h4 className={classes.vipDesc}>
              Enter a code to support your affiliate and gain a free <span role="img" aria-label="cash">💵</span> 0.50!
              <br/>If you don't have a code, use code "<b>free</b>"
            </h4>
          </Fragment>
        )}
      </DialogContent>
