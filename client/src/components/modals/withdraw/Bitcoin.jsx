      ...
      if (response.state === 1) {
        addToast(
          `Successfully withdrawed 💵 ${response.siteValue.toFixed(
            2
          )} ($${(response.siteValue.toFixed(2) / 1.4).toFixed(2)}) Bitcoin! Your withdrawal should arrive within a few minutes!`,
          { appearance: "success" }
        );
        ...
        addToast(
          `Admin verification withdraw needed for your withdraw of 💵 ${response.siteValue.toFixed(
            2
          )} ($${(response.siteValue.toFixed(2) / 1.4).toFixed(2)}) Bitcoin!`,
          { appearance: "info" }
        );
      } else {
        addToast(
