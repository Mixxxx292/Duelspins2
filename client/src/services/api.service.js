...
export const RECAPTCHA_SITE_KEY = "6LewsU4mAAAAAI1ftcWfx8f6Hs6Zpp17rLV-wd3v"; // 
...
// Get slots data
export const getSlotsURL = async (gameData, user) => {
  return new Promise(async (resolve, reject) => {
    try {
      const response = await API.post("/slots/game_url", {
        gameData,
        user
      });
      resolve(response.data);
