              ...
              <Box className={classes.notVerified}>
                <div>
                  ...
                  <p>
                    ...
                    verification you can claim your free <span role="img" aria-label="cash">💵</span> 0.50!
                  </p>
                </div>
                <Button
            ...
            <Grid className={classes.grid} container>
              <Box>
                <Box display="flex" alignItems="center">
                  <VideogameAssetIcon /> TOTAL BETS
                </Box>
                <h1>
                  {loading ? (
                    <Skeleton animation="wave" height={40} width={150} />
                  ) : (
                    parseCommasToThousands(profile.bets_placed)
                  )}
                </h1>
              </Box>
              <Box>
                <Box display="flex" alignItems="center">
                  <VideogameAssetIcon /> BETS WON
                </Box>
                <h1>
                  {loading ? (
                    <Skeleton animation="wave" height={40} width={150} />
                  ) : (
                    parseCommasToThousands(profile.bets_won)
                  )}
                </h1>
              </Box>
              <Box>
                  ...
                  <TableBody>
                    {profile.transactions.map(transaction => (
                      <TableRow key={transaction._id}>
                        ...
                        <TableCell
                          style={transaction.won ? { color: "#6BEA4B" } : { color: "#D42E25" }}
                        >
                          <span role="img" aria-label="cash">💵</span> {transaction.amount}
                        </TableCell>
                      </TableRow>
                    ))}
                  </TableBody>
