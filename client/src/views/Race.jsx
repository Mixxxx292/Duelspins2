        ...
        <Container maxWidth="lg">
          <Box className={classes.profile}>
            <Box display="flex">
              ...
              <h1 style={{ marginLeft: "auto", color: "#fff" }}>
                {loading ? (
                  <Skeleton
                    width={80}
                    height={40}
            ...
            <Box className={classes.userWrap}>
              {loadingPersonal ? (
                ...
                <span>
                  ...
                  <br />
                  You have wagered{" "}
                  <b><span role="img" aria-label="cash">💵</span> {parseCommasToThousands(personalProgress)}</b> to the
                  race!
                </span>
              )}
            </Box>
                      ...
                      {topWinners.map((entry, index) => {
                        return (
                          <TableRow>
                            ...
                            <TableCell>
                            <span role="img" aria-label="cash">💵</span> {parseCommasToThousands(entry.value.toFixed(2))}
                            </TableCell>
