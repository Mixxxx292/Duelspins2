...
app.get("/", async (req, res) => {
  return res.json({
    response: "Moonbet JSON REST API v.2.0.0",
...
// slots middle ware
const slotsware = [checkMaintenance];
...
app.use("/api/caleta/wallet", [...slotsware, require("../routes/caleta")]);
app.use("/api/bgaming", [...slotsware, require("../routes/bgaming")]);
app.use("/api/deposit", [...slotsware, require("../routes/deposit")]);
